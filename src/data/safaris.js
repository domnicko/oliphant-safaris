...
export const safaris = [
  ...
  {
    slug: "maasai-mara-honeymoon-safari-hot-air-balloon-3-days",
    name: "Maasai Mara Honeymoon Safari with Hot Air Balloon",
    destination: "Kenya",
    duration: "3 Days / 2 Nights",
    startingPrice: null,
    category: "Honeymoon Safaris",
    image:
      "https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1600&q=80",
    shortDescription:
      "A romantic escape to the Maasai Mara combining luxury, wildlife and an unforgettable hot air balloon safari over the African plains.",
    overview:
      "Experience a romantic escape to the Maasai Mara combining luxury, wildlife and an unforgettable hot air balloon safari over the African plains.",
    highlights: [
      "Sunrise hot air balloon safari with bush breakfast",
      "Sunset game drive on arrival day",
      "Maasai village cultural visit",
      "Romantic dinners at a safari camp",
    ],
    itinerary: [
      { day: 1, title: "Nairobi – Maasai Mara | Scenic Journey & Sunset Game Drive", description: "Your honeymoon begins with pickup from your Nairobi hotel or airport and departure for the Maasai Mara National Reserve. Arrive in time for lunch and check in at your romantic safari camp, then an afternoon game drive with opportunities to see elephants, lions, giraffes and zebras as the sun sets over the Mara. Meals: Lunch & Dinner. Accommodation: Sarova Mara Game Camp." },
      { day: 2, title: "Maasai Mara | Hot Air Balloon Safari & Full-Day Game Drive", description: "An early transfer to the launch site for an unforgettable hot air balloon safari, floating above the Mara plains at sunrise. After landing, enjoy a bush breakfast in the wilderness before a morning game drive, relaxation back at camp, and another game drive in the afternoon, followed by a romantic dinner. Meals: Breakfast, Lunch & Dinner. Accommodation: Sarova Mara Game Camp." },
      { day: 3, title: "Maasai Mara – Maasai Village – Nairobi", description: "After breakfast, check out and visit a Maasai village for a cultural experience, learning about local traditions, lifestyle, dances and customs. Depart for Nairobi with lunch en route, arriving in the afternoon for transfer to your hotel or the airport. Meals: Breakfast & Lunch." },
    ],
    accommodation: "2 nights at Sarova Mara Game Camp.",
    included: [
      "Private safari vehicle",
      "Professional English-speaking driver-guide",
      "2 nights' accommodation",
      ...
      "Hot air balloon safari",
      "Bush breakfast after the balloon flight",
      "Maasai village visit",
      "Bottled drinking water during the safari",
    ...
    importantInfo:
      "Priced per couple. A valid passport and any required Kenya visa/eTA are the traveler's responsibility.",
    gallery: [
      "https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1590523278191-995cbcda646b?auto=format&fit=crop&w=800&q=80",
  ...
  {
    slug: "zanzibar-honeymoon-escape-5-days",
    ...
    image:
      "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1600&q=80",
    shortDescription:
      "A tropical honeymoon in Zanzibar combining beautiful beaches, turquoise waters, island culture and romantic experiences.",
    overview:
      "Escape to Zanzibar for a tropical honeymoon combining beautiful beaches, turquoise waters, island culture and romantic experiences.",
    highlights: [
      "Beachfront relaxation with a sunset experience",
      "Spice farm visit and Stone Town cultural tour",
      "Full-day ocean excursion with snorkeling",
    ],
    itinerary: [
      { day: 1, title: "Nairobi – Zanzibar | Arrival & Beach Escape", description: "Your honeymoon begins with transfer to the airport in Nairobi for your flight to Zanzibar. On arrival, transfer to your beach resort, check in, and spend the afternoon relaxing by the pool or on the beach, followed by a romantic dinner overlooking the ocean. Meals: Lunch & Dinner. Accommodation: Paradise Beach Resort." },
      { day: 2, title: "Zanzibar | Beach & Leisure", description: "A relaxed day at the beach — swimming, resort facilities, a romantic walk along the shore, or simply relaxing together, followed by a beautiful sunset experience in the evening. Meals: Breakfast, Lunch & Dinner. Accommodation: Paradise Beach Resort." },
      { day: 3, title: "Zanzibar | Spice Farm & Stone Town", description: "Explore the cultural side of Zanzibar with a visit to a spice farm to learn about the island's famous spices, followed by a guided cultural and historical tour of Stone Town. Return to the resort for dinner and overnight. Meals: Breakfast, Lunch & Dinner. Accommodation: Paradise Beach Resort." },
      { day: 4, title: "Zanzibar | Island & Ocean Experience", description: "A full-day ocean excursion to Mnemba Island or another nearby marine area for snorkeling and swimming in clear tropical waters, followed by a romantic final dinner at the resort. Meals: Breakfast, Lunch & Dinner. Accommodation: Paradise Beach Resort." },
      { day: 5, title: "Zanzibar – Nairobi", description: "Breakfast and final leisure time at the beach before checking out and transferring to Zanzibar Airport for your flight back to Nairobi, marking the end of your honeymoon. Meals: Breakfast." },
    ],
    accommodation: "4 nights at Paradise Beach Resort, Zanzibar.",
    included: [
      "Return flights between Nairobi and Zanzibar",
      "Airport transfers",
      "4 nights' accommodation",
      "Meals as indicated",
      "Spice farm visit",
      "Stone Town tour",
      "Boat/ocean excursion",
    ...
    importantInfo:
      "Priced per couple. A valid passport and any required Tanzania visa are the traveler's responsibility.",
    gallery: [
      "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1512100356356-de1b84283e18?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1590523278191-995cbcda646b?auto=format&fit=crop&w=800&q=80",
  ...
  {
    slug: "naivasha-mount-kenya-honeymoon-escape-5-days",
    name: "Naivasha & Mount Kenya Honeymoon Escape",
    destination: "Kenya",
    duration: "5 Days / 4 Nights",
    startingPrice: null,
    category: "Honeymoon Safaris",
    image:
      "https://images.unsplash.com/photo-1516912481808-3406841bd33c?auto=format&fit=crop&w=1600&q=80",
    shortDescription:
      "A peaceful honeymoon combining the beauty of Lake Naivasha with the cool mountain atmosphere of Mount Kenya.",
    overview:
      "A peaceful honeymoon combining the beauty of Lake Naivasha with the cool mountain atmosphere of Mount Kenya.",
    highlights: [
      "Romantic Lake Naivasha boat ride",
      "Crescent Island guided walking safari",
      "Mountain lodge stay with romantic sundowner or private dinner",
    ],
    itinerary: [
      { day: 1, title: "Nairobi – Naivasha | Lake Escape", description: "Pickup from your Nairobi hotel or airport and departure for Naivasha. Check in at your lakeside resort and enjoy lunch, then a romantic boat ride on Lake Naivasha surrounded by scenery, hippos and birdlife. Return for dinner and overnight. Meals: Lunch & Dinner. Accommodation: Lake Naivasha resort." },
      { day: 2, title: "Naivasha | Crescent Island & Leisure", description: "A guided walking experience on Crescent Island among giraffes, zebras and antelopes, then lunch and an afternoon relaxing by the pool or lakeside, followed by a romantic dinner overlooking the lake. Meals: Breakfast, Lunch & Dinner. Accommodation: Lake Naivasha resort." },
      { day: 3, title: "Naivasha – Mount Kenya | Scenic Countryside", description: "Check out and depart for the Mount Kenya region through scenic Kenyan countryside. Check in at your mountain lodge and spend the afternoon relaxing in the cool surroundings, with a romantic sundowner or private dinner arranged at the lodge. Meals: Breakfast, Lunch & Dinner. Accommodation: Maiyan." },
      { day: 4, title: "Mount Kenya | Nature & Romantic Experience", description: "A relaxed morning exploring the beautiful surroundings of Mount Kenya, with options including nature walks, cycling, or spa treatments depending on the lodge, followed by a romantic evening dinner. Meals: Breakfast, Lunch & Dinner. Accommodation: Maiyan." },
      { day: 5, title: "Mount Kenya – Nairobi", description: "Breakfast, check out, and departure for Nairobi with lunch en route, arriving in the afternoon for transfer to your hotel or the airport. Meals: Breakfast & Lunch." },
    ],
    accommodation: "2 nights at a Lake Naivasha resort, 2 nights at Maiyan.",
    included: [
